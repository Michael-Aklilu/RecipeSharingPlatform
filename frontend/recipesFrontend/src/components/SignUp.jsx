...
const SignUp = ({setLoggedInUser}) => {
    ...
    return (
      ...
      <h1 className="text-3xl block text-center font-semibold text-white "><i className="fa-solid fa-user text-white"></i> Sign Up</h1>
      <hr className="mt-3" />
      <div className="mt-3">
      ...
      <div className="mt-3">
         ...
         <input type="password" name='password' id="password" onChange={handlePassword}  className="border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600" placeholder="Enter Password..." />
          ...
          <div className='mt-1 flex '>
            <Link to= "/login" className="text-white">Already have an account? Sign In</Link>
          </div>
          </form>       
          </div>  
       </div>
